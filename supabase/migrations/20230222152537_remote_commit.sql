...
--
-- Name: prices_id_seq1; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE "public"."prices" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."prices_id_seq1"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: stores_id_seq1; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE "public"."stores" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."stores_id_seq1"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."prices"
    ADD CONSTRAINT "prices_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id");
...
--
-- Name: SEQUENCE "prices_id_seq1"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE "public"."prices_id_seq1" TO "anon";
GRANT ALL ON SEQUENCE "public"."prices_id_seq1" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."prices_id_seq1" TO "service_role";
...
--
-- Name: SEQUENCE "stores_id_seq1"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE "public"."stores_id_seq1" TO "anon";
GRANT ALL ON SEQUENCE "public"."stores_id_seq1" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."stores_id_seq1" TO "service_role";
